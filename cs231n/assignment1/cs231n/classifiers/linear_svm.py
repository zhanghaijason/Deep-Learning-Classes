...
def svm_loss_naive(W, X, y, reg):
    ...
    loss += reg * np.sum(W * W)
    dW += reg*2*W    #dw = dL/dW  add the regularization part
    #############################################################################
    # TODO:                                                                     #
...
def svm_loss_vectorized(W, X, y, reg):
    ...
    margin[margin > 0] = 1
    print(margin)
    valid_margin_count = margin.sum(axis=1)  # from navie implementation, it is just counting how many wrong predictions
